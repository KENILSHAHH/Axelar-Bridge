...
const Home: NextPage = () => {
    ...
    const[chainn, setChainn] = useState({});
    ...
    // async function handleSendSourcePoly(e: React.FormEvent<HTMLFormElement>) {
    //     e.preventDefault();
    //     setLoading(true);
    //     const onSrcConfirmed = (txhash: string) => {
    //         setDestTxHash('');
    ...
    //         setLoading(false);
    //     };
    //     await sendNftToPoly(onSrcConfirmed, onSent);
    // }
    ...
    // async function handleSendBFromEthtoPoly(e: React.FormEvent<HTMLFormElement>) {
    //     e.preventDefault();
    //     setLoading(true);
    //     const onSrcConfirmed = (txhash: string) => {
    //         setTxhash('');
    ...
    //         setLoading(false);
    //     };
    //     await sendNftFromEthToPoly(onSrcConfirmed, onSent);
    // }
    // async function handleSendBackToPoly(e: React.FormEvent<HTMLFormElement>) {
    //     e.preventDefault();
    //     setLoading(true);
    //     const onSrcConfirmed = (txhash: string) => {
    //         setTxhash('');
    ...
    //         setLoading(false);
    //     };
    //     await sendNftBackToPoly(onSrcConfirmed, onSent);
    // }
